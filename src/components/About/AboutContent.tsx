    ...
    <>
      ...
      <div className="w-full">
        ...
        {activeTab === "mission" && (
          ...
          leftContent
        >
          <p className="mb-6 text-base text-dark-text"><b>
Flexibility:</b> We understand that flexibility is key in the business
        ...
        {activeTab === "vision" && (
          ...
          >
            ...
            At <b>BusinessCentre</b>, our mission is to create vibrant and flexible
             ...
             their goals. 
             <br />With state-of-the-art facilities and exceptional support, we strive 
