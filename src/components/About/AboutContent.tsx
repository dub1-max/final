        ...
        {activeTab === "about" && (
          ...
          >
            ...
            <p className="text-base text-dark-text">
              Whether you are launching a new idea or managing an established business, <b>BusinessCentre</b> provides the perfect setting to help you succeed. Join us and elevate your work experience!
            </p>
          </TabPanel>
        )}
