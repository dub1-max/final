  ...
  return (
    <div>
      ...
      <div className="w-full">
        ...
        {activeTab === "about" && (
          ...
          >
            ...
            <p className="text-base text-dark-text">
              Whether you are launching a new idea or managing an established business, <b>ConnectingMinds</b> provides the perfect setting to help you succeed. Join us and elevate your work experience!
            </p>
          </TabPanel>
        )}
        ...
        {activeTab === "vision" && (
          <TabPanel
            title="What is Our Vision in ConnectingMinds?"
            image1="/images/about/image-1.jpg"
