export default function Marina_pearl() {
  return (
        ...
        <div className="-mx-4 flex flex-wrap justify-center">
          <div className="w-full px-4 xl:w-10/12">
            ...
            >
              {/* Google Maps Iframe */}
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3609.452079140342!2d55.281009999999995!3d25.221694000000003!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3e5f43a3c394583d%3A0xc1c533857b1016e1!2sMarina%20Pearl%20Real%20Estate%20Management%20L.L.C!5e0!3m2!1sen!2sin!4v1728819293768!5m2!1sen!2sin"
                style={{
                  width: "100%",
            ...
            <div className="-mx-4 flex flex-wrap pt-12">
              ...
              <div className="w-full px-4 md:w-1/2 lg:w-1/4">
                <div className="mb-6">
                  ...
                  <p className="text-base font-medium text-dark-text">
                  East Wing, Latifa Tower - 3107B Sheikh Zayed Rd - Trade Centre - Trade Centre 1  Dubai - United Arab Emirates
                  </p>
                </div>
              </div>
              <div className="w-full px-4 md:w-1/2 lg:w-1/4">
